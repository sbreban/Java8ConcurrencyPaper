...
\author{Sergiu \textsc{Breban}} % Your name, this is used in the title page and abstract, print it elsewhere with \authorname
...
\include{Chapters/GeneralJavaConcurrency}
\include{Chapters/StreamsAndLambda} 
